...
const Hero = () => {
  return (
    <div className="relative bg-[#F5E5D7] w-full h-[600px] flex flex-col justify-center items-center gap-5 pt-48 pb-2">
      <div className="flex flex-wrap flex-row-reverse justify-start items-center gap-10">
        <img
          src={ProductImage}
        ...
        <div className="flex flex-col justify-end items-end gap-3">
          <h2 className="text-3xl font-semibold">ئۆڤەر</h2>
          <p className="text-right max-w-[400px]">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Ullam
            voluptatum repellat quia ex aspernatur cum rerum! Officia sunt
            assumenda consequatur? Numquam fugiat dolorum illo ipsum alias
            repudiandae expedita voluptatibus quae?
          </p>
